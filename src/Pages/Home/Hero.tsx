    ...
    <div className="flex-1 h-full flex items-center justify-start">
      <div className="w-full flex flex-col items-center md:items-start justify-center gap-8 px-4 md:px-20">
        <div className="flex flex-col gap-8 w-full items-center md:items-start">
          <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold">{t('welcome')}</h1>
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full items-center justify-center md:justify-start">
          <Link
            to="/register"
            className="w-full text-center px-4 py-3 text-lg font-semibold rounded-lg bg-main text-white hover:bg-main-hover transition-colors"
          >
            {t('get-started')}
          </Link>
          <Link
            to="/books"
            className="w-full text-center px-4 py-3 text-lg font-semibold rounded-lg border border-main text-main transition-colors"
          >
            {t('buy-books')}
          </Link>
        </div>
