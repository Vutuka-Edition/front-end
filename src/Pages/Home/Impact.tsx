...
const ImpactSection: React.FC = () => {
  ...
  return (
    <div
      id="news"
      className={`transition-colors duration-700 ease-in-out px-2 sm:px-4 lg:px-8 xl:px-16 bg-white-extended`}
    >
      <div className="relative h-[200vh] sm:h-[250vh] md:h-[300vh] max-w-7xl mx-auto text-neutral-900">
        ...
        <div className="sticky top-0 h-screen flex flex-col items-center justify-center text-center z-10 px-4">
          <div className="flex flex-col items-center gap-4">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl heading-1 mb-4 leading-tight">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <h1 className="text-[60px] sm:text-[80px] md:text-[120px] lg:text-[160px] xl:text-[200px] text-main-hover heading-display leading-none">
                  ...
                  <CountUp end={impactStats[activeIndex].value} duration={2} separator="," />
                </h1>
                <p className="text-lg sm:text-xl md:text-2xl font-bold text-main">
                  {impactStats[activeIndex].title}
                </p>
                <p className="text-neutral-500 text-xs sm:text-sm max-w-md sm:max-w-lg mx-auto">
